...
public class RedisClusterTest {
    private static final String REDIS_CON_URL = "redis:/127.0.0.1:6300"; //로컬 redis 0번 사용
    public static GenericObjectPool<StatefulRedisClusterConnection<String, String>> pool = null; //sync & 비 클러스터모드 커넥션풀
...
//        pool = nonClusterPoolUsage();
    ...
    private static void testSetValue(String key, String value) {
        ...
        try (StatefulRedisClusterConnection<String, String> connection = pool.borrowObject()) { //pool을 이용해서 커맨드 실행
